...
// TODO: May need a function that generates options within select based on inventory of given item
// Could do const cartItemHTML = ___.
// then for i < item.inventory, create option with value i.
// Probably have to wrap the select in a span? Or create a span INSIDE the <select>, then generate its innerHTML as mentioned above.





// TODO: The children of <select> will be wrapped in a span.
// I will write a function that iterates over i < inventoryQty to create a list of options from 0-inventoryQty. Default value == count of item in current basket.
// Then will use innerHTML = X to insert it.
...
function insertCartHTML(dataSource) {	
	...
	// and insert buyBoxHTML into div class="buy-box"
