...
function createUpdateCartQuantityButtonListeners() {	
	...
	function updateQuantity() {
		...
		const currentItemSelectQuantity = event.currentTarget;
		console.log(currentItemSelectQuantity);
		
		const currentItemQuantity = currentItemSelectQuantity;
		
		
		const newQuantityValue = currentItemSelectQuantity.value;
		console.log(newQuantityValue);
		
		// const matchingCartItem = 
		
		// TODO: Need to change the 'selected' option when event fires
		...
		// Set matchingCartItem.quantity = current <select> value. Same manner as in updateCartIfExistingItem()
