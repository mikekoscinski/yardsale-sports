...
function addToCart(button) {
	...
	updateCartQuantityTextInHeader();
}
...
function updateCartQuantityTextInHeader() {
...
// TODO: Remove caption for autographs; add back modal caption
	...
	return `
		<div class="autograph">
			...
			<img 
				...
				tabindex="0" 
				title="${player.name} Autographed Baseball"
				data-description="${player.position} for ${player.team}"
			>
			<div class="caption">
...
// TODO: Can I remove these return statements and just return the forEach execution?
...
function Gallery(gallery) {
	...
	function showImage(el) {
		...
		// Validate before setting; cards do not have a description
