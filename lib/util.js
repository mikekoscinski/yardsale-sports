...
function createUpdateCartQuantityButtonListeners() {	
	...
	function updateCartItemQuantity() {		
		...
		// Find matchingCartItem from cartItems in localStorage
		...
		// Set matchingCartItem.quantity = newItemQuantity
		matchingCartItem.quantity = newItemQuantity;
				
		// Rewrite cartItems to localStorage and update header text
		writeItemsToStorageAndUpdateHeader();
