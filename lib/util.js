...
// TODO: outOfStock alerts create a Chrome error; need better long-term solution


// TODO: CART # TEXT is not updated in real-time
...
// It needs to be the JSON.parse() and not the cartItems variable because cartItems is set when localStorage is read on initial page load. It is not regularly updated thereafter. But localStorage is
const totalCartQuantityFromLocalStorage = (localStorage.getItem('cartItemsKey') === null) ?
	0
	:
...
function addToCart(button) {
	...
	function writeItemsToStorageAndUpdateHeader () {
		...
		localStorage.setItem('cartItemsKey', JSON.stringify(cartItems)); // TODO: this isn't getting updated the moment an addToCart event occurs
