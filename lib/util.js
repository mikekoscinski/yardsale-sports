...
function Gallery(gallery) {
	...
	function showNextImage() {
		...
		// const nextImage = currentImage.parentElement.nextElementSibling.querySelector('img');
		
		const isThereANextImage = Boolean(currentImage.parentElement.nextElementSibling.nextElementSibling).valueOf();
		
		console.log(isThereANextImage);
		
		const nextImage = (!isThereANextImage) ? 
			null :
			currentImage.parentElement.nextElementSibling.firstElementChild.nextElementSibling;
