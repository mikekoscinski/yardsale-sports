...
function makePlayerHTML (player) {
	...
	console.log(isAutographGallery);
	console.log(isCardsGallery);
	
	// TODO: Add conditional logic to determine img attribute names? E.g. If player is of type "autograph", use "data-team", "data-position". If of type card, use "data-issuer", "data-year".
...
function insertPlayerHTML (dataSource) {
	dataSource.forEach(el => {		
		...
		if (staticGallery) return staticGallery.insertAdjacentHTML('beforeend', makePlayerHTML(el));
	});
}
