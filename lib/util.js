...
function createUpdateCartQuantityButtonListeners() {	
	...
	function updateQuantity() {
		...
		const newItemQuantity = event.currentTarget.querySelector('option:checked');
		newItemQuantity.selected = true;
		...
		// Find matching cartItem in localStorage based on item title associated with the currentTarget <select> menu (grab and store the title as local variable?)
